...
public class PostController {
    ...
    //글 작성 postuser, postusername, posttitle, postcontent, postimg, postlocation, xpoint, ypoint
    ...
    //게시글 수정 postid, postimg, postoldimg, posttitle, postcontent, postlocation, xpoint, ypoint
